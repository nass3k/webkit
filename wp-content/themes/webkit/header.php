    ...
    <div class="container">
        <div class="container-inner">
            <a href="<?= home_url(); ?>" class="logo">
                <svg class="icon"> <?= the_custom_logo(); ?></svg>
            </a>

            <nav class="main-nav">
                <a href="/portfolio/" data-badge="" class="link">Портфолио</a>

                <div class="link parent">
                    <span>Услуги</span>
                    <div class="child-items">
                        <a href="/services/web-dev/" data-badge="" class="link">Веб-разработка</a>

                        <a href="/services/promotion/" data-badge="" class="link">Продвижение</a>
                    </div>
                </div>

                <a href="/blog/" data-badge="" class="link">Блог</a>
                <a href="/contacts/" data-badge="" class="link">Контакты</a>
                <div class="nav-track">
...
<div class="overlay-navigation">
    <div class="container narrow">
        <div class="top">
            <div class="left">
                <a class="h1 link animation-element animation-delay-1" href="/portfolio/"><span>Портфолио</span></a>

                <div class="h1 link animation-element animation-delay-2"><span>Услуги</span></div>

                <a href="/services/web-dev/" class="link-child animation-element animation-delay-5"><span>Веб-разработка</span></a>
                <a href="/services/promotion/" class="link-child animation-element animation-delay-5"><span>Продвижение</span></a>
                <a class="h1 link animation-element animation-delay-1" href="/blog/"><span>Блог</span></a>
                <a class="h1 link animation-element animation-delay-1" href="/contacts/"><span>Контакты</span></a>
            </div>
            <div class="right">
        ...
        <div class="bottom animation-element animation-delay-10">
            ...
            <div>
                <a href="mailto:info@webkit.pw">info@webkit.pw</a>
            </div>
            <div>
